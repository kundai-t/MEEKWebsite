var urlRoute="https://meekapi20201003140427.azurewebsites.net/API/Application/GetMeetingPitches";
    ...
    window.addEventListener('load',function(){
        sendHttpRequest('POST',urlRoute,{ 
            ...
            for(var i=0; i<data.length; i++){
                ...
                html +="</div>";
                html +="</div>";
                html +="<a href='InvestorPitchProcess.html?pitchId="+data[i].PitchID+"&pitchName="+data[i].PitchName+"' class='border-btn border-btn2'>Track</a>";
                html +="</div>";
                html +="</div>";
                html +="</div>";
                html +="</div>";
