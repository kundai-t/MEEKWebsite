...
const urlRouteGetRequirements = "https://meekapi20201003140427.azurewebsites.net/API/Application/GetInvestorRequirements";
    ...
    window.addEventListener('load',function(){
        sendHttpRequest('POST',urlRouteGetRequirements,{
            ...
            for(var i=0; i<data.length; i++){
                ...
                html +="<p id='pitch-role'><span>Estimated Budget:</span>R"+data[i].Budget+"</p>";
                html +="<div class='properties__footer d-flex justify-content-between align-items-center'>";
                html +="<div class='restaurant-name'>";
                html +="<p class='h3'>Maximum Investment: </p>";
                html +="</div>";
                html +="<div class='price'>";
                html +="<span>R"+data[i].MaximumAmount+"</span>";
                html +="</div>";
                html +="</div>";
                html +="</div>";
                html +="</div>";
