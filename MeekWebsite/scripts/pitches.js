var urlRoute="https://meekapi20201003140427.azurewebsites.net/API/Application/GetUsersPitch";
    ...
    window.addEventListener('load',function(){
        sendHttpRequest('POST',urlRoute,{ 
            ...
            for(var i=0; i<data.length; i++){
                ...
                html +="</div>";
                html +="</div>";
                html +="<a href='InnovatorPitchProcess.html?Id="+data[i].PitchID+"&Industry="+data[i].Industry+"' class='border-btn border-btn2'>Find out more</a>";
                html +="</div>";
                html +="</div>";
                html +="</div>";
                html +="</div>";
