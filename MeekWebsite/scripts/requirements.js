...
document.getElementById('industry-group').innerText=category;
...
const urlRoute = "https://meekapi20201003140427.azurewebsites.net/API/Application/GetInvestorRequirements";
    window.addEventListener('load',function(){
        sendHttpRequest('POST',urlRoute,{
            ...
            for(var i=0; i<data.length; i++){
                ...
                html +="<p id='pitch-category'>"+data[i].ProjectGroup+"</p>";
                html +="<h3><a href='#' id='pitch-name'>"+data[i].FirstName+"</a></h3>";
                html +="<p id='pitch-location'><span>Location<img src='assets\\solid\\placeholder.svg' width='25' height='25'/>:</span>"+data[i].Location+"</p>";
                html +="<p id='pitch-stage'><span>Stage<img src='assets\\solid\\flag.svg' width='25' height='25'/>:</span>"+data[i].Stage+"</p>";
                html +="<p id='pitch-role'><span>Maximum Amount<img src='assets\\solid\\ceo.svg' width='25' height='25'/>:</span>"+data[i].MaximumAmount+"</p>";
